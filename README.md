...
Recipe cache shard for **[foodrecipes.page](https://foodrecipes.page)** — AI-generated recipes whose slug starts with **the letter 'c'**.
...
```
https://cdn.jsdelivr.net/gh/foodrecipes-page/recipes-c@main/recipes/<cuisine>/<diet>/<slug>.json
```
